        ...
        <div class="widget-box">
            <div class="widget-title">            <?php
             gravar() {
                ...
                $data = array(
                    'coluna1' => $this->input->post('bateria'),
                    'coluna2' => $this->input->post('acessorios'),
                    'coluna3' => $this->input->post('bag'),
                    'coluna4' => $this->input->post('radiocontrole'),
                    'coluna5' => $this->input->post('carregador')
                );
                $this->Os_model->inserir($data);
                redirect('os');
            }
                        ...
                        <div class="tab-pane active" id="tab1">
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div> <form method="post" action="<?php echo base_url(); ?>index.php/os/gravar">
                                        <input type="text" name="baterias" placeholder="baterias" required>
                                        <input type="text" name="bag" placeholder="bag" required>
                                        <input type="text" name="acessorios" placeholder="acessorios" required>
                                        <input type="text" name="carregador" placeholder="carregador" required>
                                        <input type="text" name="radiocontrole" placeholder="radiocontrole" required>
...
<?php
// filepath: /c:/Users/Marcondes/Downloads/MAPOS ATUALIZADO/mapos/application/models/Os_model.php
class Os_model extends CI_Model {
    public function inserir($data) {
        $this->db->insert('minha_tabela', $data);
    }
}

// filepath: /c:/Users/Marcondes/Downloads/MAPOS ATUALIZADO/mapos/application/config/routes.php
$route['os/gravar'] = 'os/gravar';
